...
* Descrição: enviar notificações para eventos importantes, como solicitações e respostas de amizade, mensagens, grupos e estabelecimento ou encerramento de vínculo familiar.
